...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    //template_fihfv2o
    //service_x5l4urw
    emailjs.send('service_x5l4urw', 'template_fihfv2o', 
    {
      from_name : form.name, to_name: 'Abdelnour', from_email: form.email, to_email : 'abdelnour.rekkab@gmail.com', message : form.message
      },
    'kLfqM2Qp4-Emv7xJp'
     )
     .then(() => {
      setLoading(false);
      alert("Merci pour votre message, je vous répondrais dans les plus bref délais.");
